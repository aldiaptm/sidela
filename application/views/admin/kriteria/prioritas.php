                    ...
                    <div class="col-lg-12">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Prioritas Kriteria</h6>
                            </div>
                            <div class="card-body">
                                <?php if (!empty($kriteria)) : ?>
                                    <?= $this->session->flashdata('pesan_sukses') ?>
                                    <?= $this->session->flashdata('pesan_error') ?>
                                    <?= form_open('admin/kriteria/prioritas') ?>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-center" colspan="3">
                                                        ...
                                                        <a href="#" data-href="<?= site_url('admin/kriteria/reset') ?>" data-toggle="modal" data-target="#confirm-reset" class="btn btn-danger">Reset</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <?= form_close() ?>
                                <?php else : ?>
                                    <div class="alert alert-warning" role="alert">Tidak ada data kriteria</div>
                                <?php endif; ?>
                                ...
                                <?php if (isset($_POST['check']) and empty($this->session->flashdata('pesan_error'))) : ?>
                                    ...
                                    <h3 class="mt-4">Matriks Nilai Kriteria (Normalisasi)</h3>
                                    <div class="table-responsive">
                                        <table class="table-prioritas">
                                            <?= $list_data2 ?>
                                        </table>
