<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="<?= base_url('kades/dashboard') ?>" class="nav-link" style="color:white  ; font-size:17px;">Home</a>
                </li>
            </ul>
            <!-- Right navbar links -->
        </nav>
        ...
        <aside class="main-sidebar sidebar-dark-success elevation-4" style="height: 100vh;">
            <!-- Brand Logo -->
            <a href="<?= base_url('kades/dashboard') ?>" class="brand-link d-flex justify-content-center">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="<?= base_url('kades/dashboard') ?>" class="nav-link">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p style="color: white; ">Dashboard</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('kades/datapenduduk') ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('kades/mutasimd') ?>" class="nav-link ">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p style="color: white; font-size: 18px; ">Meninggal Dunia</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('kades/mutasibt') ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                ...
                <div class="mt-5 d-flex justify-content-center">
                    <form action="<?= base_url('kades/logout') ?>" method="post">
