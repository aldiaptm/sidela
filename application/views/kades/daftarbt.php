            ...
            <tbody>
                ...
                foreach ($detail_pindah as $data) : ?>
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="<?= base_url('admin/statuspersetujuan_bt/setuju/' . $data->id_penduduk) ?>" class="btn btn-primary btn-sm">
                                    <i class="fas fa-check"></i> Setuju
                                </a>
                                <span style="margin-left: 7px;"></span>
                                <a href="<?= base_url('admin/statuspersetujuan_bt/tolak/' . $data->id_penduduk) ?>" class="btn btn-warning btn-sm">
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="<?= base_url('admin/hapusmd/hapus/' . $data->id_penduduk) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus?');">
