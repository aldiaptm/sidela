<div class="card card-primary">
    ...
    <!-- form start -->
    <form action="<?php echo base_url('kades/editpenduduk/update/' . $penduduk->id_penduduk) ?>" method="POST">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nik" placeholder="Masukan nik" name="nik" value="<?= $penduduk->nik ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="tempat_lahir" placeholder="Masukan tempat lahir" name="tempat_lahir" value="<?= $penduduk->tempat_lahir ?>">
            </div>
            <div class="form-group">
                <label for="tanggal_lahir">Tanggal Lahir</label>
                <input type="date" class="form-control" id="tanggal_lahir" placeholder="Masukan tanggal lahir" name="tanggal_lahir" value="<?= $penduduk->tanggal_lahir ?>">
            </div>

            <div class="form-group">
                <label for="jenis_kelamin">Jenis Kelamin</label>
                <select class="form-control" id="jenis_kelamin" name="jenis_kelamin" value="<?= $penduduk->jenis_kelamin ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="alamat" placeholder="Masukan Alamat" name="alamat" value="<?= $penduduk->alamat ?>">
            </div>
