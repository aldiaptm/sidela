...
|
*/
$config['base_url'] = 'http://localhost/sidela/';
...
|
*/
$config['sess_driver'] = 'database'; // Gunakan database sebagai driver session
$config['sess_cookie_name'] = 'ci_session'; // Nama cookie session
$config['sess_expiration'] = 7200; // Waktu kedaluwarsa session dalam detik
$config['sess_save_path'] = 'ci_sessions'; // Nama tabel session pada database
$config['sess_match_ip'] = FALSE; // Cocokkan IP untuk session
$config['sess_time_to_update'] = 60; // Waktu untuk memperbarui session
$config['sess_regenerate_destroy'] = FALSE; // Regenerate session saat login
