...
class Penilaian extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['tabel1'] = $hasil['tabel1'];
        $data['tabel2'] = $hasil['tabel2'];

        $data['title'] = 'DATA USER';
        $this->load->view('template/header', $data);
        $this->load->view('template/sidebar', $data);
        $this->load->view('admin/penilaian/index', $data); // Menambahkan $data ke view 'admin/datapenduduk'
    ...
    public function saw()
    {
        ...
        if (!empty($arr_alternatif)) {
            ...
            $var_rumus .= '<h4 class="mt-4 mb-1">Perankingan</h4>';
            $var_rumus .= '<table class="table table-bordered">';
            $var_rumus .= '
            <thead>
                <tr>
                    ...
                    <td class="text-center font-weight-bold">Nilai</td>
                </tr>
            </thead><tbody>';
            ...
            foreach ($v as $row) {
                $var_rumus .= '<tr>';
                $var_rumus .= '<td class="text-center">' . $no++ . '</td>';
                $var_rumus .= '<td class="text-center">' . $row['kode_alternatif'] . '</td>';
                $var_rumus .= '<td>' . $row['nama_alternatif'] . '</td>';
                $var_rumus .= '<td class="text-center">' . $row['nilai_saw'] . '</td>';
                $var_rumus .= '</tr>';
            }
