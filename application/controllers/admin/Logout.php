        ...
        // Jika pengguna belum mengkonfirmasi keluar
            ...
            echo '<script>
                    if(confirm("Apakah Anda yakin ingin keluar?")) {
                        window.location.href = "' . base_url('admin/logout') . '?confirm=true";
                    } else {
                        window.location.href = "' . base_url('admin/dashboard') . '"; // Redirect kembali ke halaman dashboard jika pengguna membatalkan
                    }
                </script>';
        }
    }
